...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:SideeXWebSevicePlugin:1.0");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","D:\\workspace\\SideeXWebSevicePlugin");
    parameters.put("artifactId","SideeXWebSevicePlugin");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","D:\\workspace\\SideeXWebSevicePlugin\\target\\classes");
    parameters.put("testOutputDirectory","D:\\workspace\\SideeXWebSevicePlugin\\target\\test-classes");
